...
- Added a read-only SQLite inventory ledger that records scans, file identity, DBPF package parse status, resource keys, snapshots, event-log entries, changed-since-last-scan counts, and JSON-serializable snapshot exports.
