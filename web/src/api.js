...
import { updateDeskOptions, updateDeskPlanOptions } from './updateDeskApiModel';
import {
...
import { patchDayOptions } from './patchDayApiModel';
...
export const api = {
  ...
  patchDayStatus: (sims4Path, callbacks, options = {}) =>
