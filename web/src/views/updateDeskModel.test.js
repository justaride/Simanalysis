...
const UPDATE_PLAN = {
    ...
    actions: [
        ...
        {
            action_id: 'update-archive-member-003',
            action_type: 'stage_archive_member',
            status: 'planned',
            source_name: 'cool.zip: Mods/cool.package',
            source_relative_path: 'cool.zip',
            archive_member_path: 'Mods/cool.package',
            destination_relative_path: 'cool.package',
            extraction_staging_relative_path: '_Simanalysis_UpdateDesk/archive-members/cool/cool.package',
            extracts_directly_to_mods: false,
            expected: { size: 1024, sha256: 'fed789' },
            source_binding: { status: 'missing' },
            archive_scan: { status: 'readable_zip', member_count: 2 },
            blockers: [],
